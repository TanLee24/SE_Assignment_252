...
4. IoT-SPMS1 mã hóa thông tin hóa đơn và gọi API khởi tạo giao dịch sang BKPay.
...
7. BKPay gọi API Webhook trả về trạng thái giao dịch thành công cho IoT-SPMS1.

8. IoT-SPMS1 cập nhật trạng thái hóa đơn thành "Đã thanh toán".
\\
\hline

\textbf{Luồng ngoại lệ} & 
\textbf{Giao dịch thất bại / Hủy bỏ}: BKPay trả về trạng thái lỗi. IoT-SPMS1 giữ nguyên trạng thái hóa đơn, hiển thị thông báo "Thanh toán thất bại" cho người dùng.- Mất kết nối API: IoT-SPMS1 không gọi được BKPay, hiển thị thông báo "Cổng thanh toán đang bảo trì".
\\
\hline

...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{pictures/act_diagram/parkinglot_act.jpg} 
    \caption{Activity Diagram cho use-case Hiển thị trạng thái bãi đỗ và điều hướng}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{pictures/act_diagram/electscreen_act.jpg} 
    \caption{Activity Diagram cho use-case Admin cấu hình bảng điện tử}

...
\subsection{Architectural Layer Design}
...
\begin{figure}[htbp]
    \begin{verbatim}
        ├── src/
        │   ├── iot/                        # Phần mềm IoT (placeholder)
        │   └── web_app/                    # Ứng dụng web chính
        │       ├── data/                   # Dữ liệu JSON
        │       │   ├── users.json          # Danh sách người dùng
        │       │   ├── sessions.json       # Lịch sử phiên đỗ xe
        │       │   ├── transactions.json   # Giao dịch thanh toán
        │       │   ├── audit_log.json      # Nhật ký hệ thống
        │       │   └── dynamic_guidance/
        │       │       └── parking_status.json  # Trạng thái bãi đỗ
        │       │
        │       └── public/                 # Tài nguyên web tĩnh
        │           ├── index.html          # Trang chủ
        │           ├── login.html          # Trang đăng nhập
        │           ├── theme.css           # Stylesheet chung
        │           ├── theme.js            # JavaScript chung
        │           │
        ...
        │           │   └── shared.js       # Module chung cho admin
        │           │
        ...
        │           │   ├── history.html
        │           │   ├── billing.html
        │           │   └── shared.js       # Module chung cho user
        │           │
        │           ├── guard/              # Giao diện Nhân viên vận hành
        │           │   ├── dashboard.html
        │           │   ├── status.html
        │           │   ├── signage.html
        │           │   └── shared.js       # Module chung cho guard
        │           │
        │           ├── pricing/            # Giao diện Thanh toán
        │           │   ├── payment.html
        │           │   ├── bkpay.html
        │           │   ├── pricing.html
        │           │   └── assets/
        │           │       └── scripts/
        │           │           ├── pricing-services.js     # BillingService
        │           │           ├── pricing-page.js         # Logic trang pricing
        │           │           ├── bkpay-page.js           # Logic trang BKPay
        │           │           ├── billing-page.js         # Logic trang billing
        │           │           └── pricing-services.js     # PaymentService
        │           │
        │           ├── dynamic_guidance/   # Bảng LED & Điều hướng
        │           │   ├── admin-control.html
        │           │   ├── global-display.html
        │           │   ├── launcher.html
        │           │   ├── local-display.html
        │           │   └── assets/
        │           │       └── scripts/
        │           │           ├── admin.js        # GuidanceDisplayService
        │           │           ├── core.js         # Core logic
        │           │           └── signage.js      # Signage control
        │           │
...
\subsection{UML Architectural Diagram}
...
\subsection{Implementation Logic (Interaction Flow)}
...
\subsubsection{State Management for Payment}
...
\subsubsection{Idempotency for Webhook}
...
\subsubsection{Data Synchronization Strategy}
